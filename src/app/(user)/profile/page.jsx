...
export default async function ProfilePage() {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-blue-100 via-purple-100 to-purple-200 flex flex-col items-center py-12">
            <div className="bg-white p-10 rounded-2xl shadow-2xl w-full max-w-md space-y-8 transition-all duration-300 hover:shadow-purple-300">
